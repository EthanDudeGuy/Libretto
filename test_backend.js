...
async function testBackend() {
  ...
  try {
    ...
    console.log('\nNext steps:');
    console.log(
      '1. If API key is not configured, set your ANTHROPIC_API_KEY environment variable'
    );
    console.log(
      '2. Or edit the backend_server.py file and replace "your_api_key_here" with your actual key'
    );
